    ...
    <>
      ...
      <main className="matricula-hero">
        <div className="matricula-info">
          ...
          <p><strong>Preencha somente após:</strong></p>
          <ul>
            <li>Confirmação de vaga pela escola</li>
            <li>Ou encaminhamento do Cadastro Escolar</li>
          </ul>

          <p>
            ⚠️ A vaga só será confirmada após conferência dos documentos e assinatura presencial.
          </p>
          ...
          {/* CHECK */}
          <label className="confirmacao-container">
            <input
              type="checkbox"
              checked={confirmado}
            ...
            />
            <span>
              Estou ciente de que o preenchimento online não garante a vaga.
            </span>
          </label>
          ...
          <div className="matricula-cta-group">
            {confirmado ? (
              ...
              <div className="matricula-btn-primary disabled">
                Iniciar Preenchimento
              </div>
            )}
          </div>
